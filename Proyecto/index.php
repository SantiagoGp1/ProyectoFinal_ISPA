...
?>
                        <form action="./enlace/config/insertarusuario.php" method="POST">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input required type="password" class="form-control" id="passwdConfirm" aria-describedby="passwdConfirmHelp">
                                </div>
